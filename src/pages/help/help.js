        ...
        <>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.back}>
                    ...
                    <Image style={styles.helpPng} source={require('../../assets/help-title-img.png')} />
                </View>
                <ScrollView style={{ height: 500 }} showsVerticalScrollIndicator={false}>
                    <View style={styles.row}>
                        ...
                        <View style={{ paddingVertical: 20 }}>
                            <Text style={styles.lorem}>Lorem ipsum dolor sit amet, consectetur adipiscing</Text>
                            <Text style={styles.lorem}>edit, sed do eiusmod tempor incidiunt ul labore</Text>
                        </View>
                        <HelpCard

      ...
      <View style={styles.container}>
        <View style={{ width: "100%", height: "33%" }}>
          <View style={{
            ...
            >
              <Image style={styles.back} source={require('../../assets/backIcon.png')} />
            </TouchableOpacity>
            <View>
              <Text style={styles.platText}>SETTINGS</Text>
            </View>
          </View>
          <Image style={{ width: "100%", height: "100%", resizeMode: "contain" }} source={require('../../assets/settingsTitle.png')} />
        </View>
        ...
        <View style={{ backgroundColor: "#efeeef", width: "92%", height: 1, alignSelf: "center" }}></View>
        <View style={styles.row}>
          <Text style={styles.text}>Voice</Text>
          <View style={styles.dropDown}>
            <Text style={{ color: "#bfcfc7", fontWeight: "bold" }}>Girl/Boy</Text>
            <Image style={styles.back1} source={require('../../assets/drop-down.png')} />
          </View>
        ...
        <View style={styles.row}>
          ...
          <View style={styles.textSize}>
            ...
            <Slider
          style={{width:"75%"}}
          thumbStyle={{width:"10%",height:"30%",shadowColor: "#000",
          shadowOffset: {
            width: 0,
            height: 2,
          },
